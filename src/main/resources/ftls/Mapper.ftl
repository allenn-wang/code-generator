...
<mapper namespace="${rootPackageName}.${daoPackageName}.${table.className}${daoClassName}" >
    ...
    <select id="queryList${dtoClassName}" parameterType="${rootPackageName}.${entityPackageName}.${table.className}Example" resultMap="${table.className}${dtoClassName}">
        select
    ...
    <select id="queryList" parameterType="${rootPackageName}.${entityPackageName}.${table.className}Example" resultMap="${table.className}">
        select
    ...
    <select id="count" parameterType="${rootPackageName}.${entityPackageName}.${table.className}Example" resultType="java.lang.Long">
    ...
    <select id="select${dtoClassName}ByPrimaryKey" parameterType="java.lang.${table.primaryKeyColumn.javaType}" resultMap="${table.className}${dtoClassName}">
		select
			<include refid="Base_Column_List_Dto" />
	<![CDATA[
		from ${table.name}
